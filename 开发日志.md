...
- 从零开始部署PuerTs
  ...
  - TS脚本和引擎的交互
    - TS脚本的成员变量在蓝图中的表现
      ...
      - 查看日志：incremental compile xxx,说明已经出发增量编译，可以查看编译结果，然后重新打开TS_Player蓝图
...
# Puerts如何为我们生成BP和热更？
  - CodeAnalyze
    - PuertsEditorModule启动时，如果我们已经开启了自动启用则会创建虚拟机，并启动CodeAnalyze脚本，这应该是Puerts非常核心的代码。
...
# 如何打包测试本项目：
    - 已有的打包好的的Win包链接：https://pan.quark.cn/s/ef433fd4b1e3
